...
print("6. Loan approval is influenced by financial attributes like Annual Income, Credit Score, Loan Amount and EMI.")
print("7. Correlation does not imply causation.")
print("8. Feature ranking helps in selecting important variables for machine learning models.")

# ------------------------------------------------------------
# 9. Pairplot Visualization (Single Figure)
# ------------------------------------------------------------
