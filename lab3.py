...
data = {
    ...
    "Salary": [
        50000, np.nan, 65000, 70000, 70000,
    ...
    "City": [
        "Delhi", "Mumbai", "Delhi", "Chennai", "Chennai",
...
clean["Gender_Label"] = label.fit_transform(
    clean["Gender"]
)
...
comparison = pd.DataFrame({
    ...
    "Processed Missing": clean[df.columns].isnull().sum()
})
